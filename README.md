# Chemistry Lecture Notes Repository

A comprehensive collection of lecture notes for BSc and MSc Chemistry programs.
...
1. Navigate to the desired year and semester folder
2. Each subject has its own subfolder containing:
   - Lecture notes (PDF/Markdown)
...
These notes are for educational/reference purposes only. Always refer to your official textbooks.
